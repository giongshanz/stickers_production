...
Chỉ thư mục `references/Stickers` được dùng để xác định phong cách hình ảnh. Danh sách thư mục sticker trong dự án chỉ đã được đối chiếu để tránh lặp nguyên tên chủ đề, không được dùng làm mẫu phong cách. Mẫu thử `beehive-skep-pilot.png` có tương phản và độ bóng không phù hợp, đã bị loại; master `beehive-skep` hiện tại đã là bản thay thế có tương phản dịu hơn.
...
Hình đầu ra cần nền trong suốt thật, đủ khoảng đệm, không bị cắt chi tiết và dùng target trong prompt 512 × 512; giữ kích thước thực tế công cụ trả về, không resize bằng script. Trước khi đóng gói, kiểm tra đọc được ở kích thước chơi thực tế, không thêm chữ vô nghĩa, không thừa vật thể, không lẫn nền màu trắng vào alpha và không có khác biệt phong cách giữa các lượt tạo.
