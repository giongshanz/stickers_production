...
Nguồn phong cách duy nhất: `references/Stickers/`. Bộ trong project không dùng làm chuẩn phong cách.
...
Mẫu tổ ong đầu tiên `revisions/rejected/beehive-skep-pilot.png` bị loại: tương phản cao, bóng mạnh, vân dày và khối quá giống render 3D.
