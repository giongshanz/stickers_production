...
report = {
    ...
    "id": ID,
    "reason": "First output closely copied the frog reference face. Replacement has a shorter turtle snout, four clawed legs and more legible segmented shell.",
