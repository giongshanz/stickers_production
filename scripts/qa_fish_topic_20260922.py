"""Inspect the eight selected fish PNGs against catalogue-like light/dark backgrounds."""
...
OUT = ROOT / "qa" / "fish-collection-20260922"
IDS = (
    "fish-clownfish", "fish-blue-tang", "fish-koi", "fish-betta",
    "fish-pufferfish", "fish-lionfish", "fish-seahorse", "fish-manta-ray",
)
...
def main():
    ...
    for slot, aid in enumerate(IDS):
        ...
        delivery = ROOT / "delivery" / "stickers" / "fish-collection" / f"{aid}.png"
